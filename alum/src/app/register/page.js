  ...
  return (
    <div className="register-page">
      <div className="left">
        ...
        <div className="image">
          <img className="image-29-icon" src="./image-29@2x.png" alt="error"></img>
          <img className="image-28-icon" src="./image-28@2x.png" alt="error"></img>
        </div>
      </div>
      <div className="right">
        ...
        <div className="options">
          <div className={`thirty-5 right ${type == "alumni" && "active"}`}
            onClick={(e) => {
              setType("alumni");
            }}
          >
            <img className="image-35-icon" src="./image-35@2x.png" alt="error"></img>
            <p className="content-35">Alumni</p>
          </div>
          
          <div className={`thirty-4 left ${type == "student" && "active"}`}
              onClick={(e) => {
                setType("student");
              }}>
            <img className="image-34-icon" src="./image-34@2x.png" alt="error"></img>
